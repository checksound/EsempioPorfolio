...
import porfolio4.exception.DailyWithdrawnLimitException;
import porfolio4.exception.PorfolioException;
import porfolio4.exception.SingleWithdrawnLimitException;
...
public class TestPortafoglio {
	...
	private static void statusPortafoglio(Portafoglio portafoglio) {
		...
		out.println("* Lista prelievi: " + portafoglio.getListOperazioni());
	...
	public static void main(String[] args) throws TestException {
		...
		System.out.println(portafoglio.getListOperazioni());
